      ...
      <div className="pizza-block">
        ...
        <div className="pizza-block__selector">
          ...
          <ul>
            {
              sizes.map((size, i) => (
                <li key={size} onClick={() => setActiveSize(i)} className={activeSize == i ? 'active' : ''}>{size} cм.</li>
              ))}
...
//key={typeId} - ключ нада вставлять в родітєлській елємєнт кожного map. Це обично той аргумєнт, якій передається мапу в дужках. 