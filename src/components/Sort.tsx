  ...
  return (
    <div ref={sortRef} className="sort"> 
      <div className="sort__label">
        ...
        {/* setOpen(!open) оце воно переключатєльом робиться */}
      </div>
      {
        open && ( //open && це якшо ліва часть тру, то виконай праву часть, у нас в стейті false, тобто не відображається попап
